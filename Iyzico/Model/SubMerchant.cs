...
namespace Iyzipay.Model
{
    public class SubMerchant : IyzipayResource
    {
        ...
        {
            return RestHttpClient.Create().Put<SubMerchant>(options.BaseUrl + "/onboarding/submerchant", request, options);
        }

        public static SubMerchant Retrieve(RetrieveSubMerchantRequest request, Options options)
        {
            return RestHttpClient.Create().Post<SubMerchant>(options.BaseUrl + "/onboarding/submerchant/detail", request, options);
        }
    }
}
